  ...
  return (
    <div className="background">
      ...
      <div className="theme theme__2">
        <img className="theme__2__img" src={theme__1} alt="" />
      ...
      <div className="theme theme__3">
        <img className="theme__3__img" src={theme__1} alt="" />
      ...
      <div className="theme theme__4">
        <img className="theme__4__img" src={theme__1} alt="" />
      ...
      <div className="theme theme__5">
        <img className="theme__5__img" src={theme__1} alt="" />
      ...
      <div className="theme theme__6">
        <img className="theme__6__img" src={theme__1} alt="" />
